...
<link rel="stylesheet" href="ops-style.css?v=20260513c80" />
<style>
...
(function(){
  ...
  function saveState() {
    try {
      localStorage.setItem('ue-state', JSON.stringify({ year: currentYear, tier: tierFilter, sort: sortState, q: searchQ }));
    } catch (e) {}
  }
  function loadState() {
    try {
  ...
  // Save state on every user-driven change (year, tier, sort, search) + sync URL hash
